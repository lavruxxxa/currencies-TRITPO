...
Большинство людей интерисуются курсами валют, чтобы определить как лучше оперировать их сбережениями. Есть разные способы узнать курс интерисующей валюты. Например, на официальном сайте банков. Однако это долго, и не всегда присутствует подключение к интернету. Приложение будет разработано с целью упростить процесс поиска необходимой информации о курсах, а так будет возможность сохранить информацию в кеше телефона, для оффлайн доступа к курсам.
...
### 3.2.3 Ограничения
1. Приложение будет реализовано на платформе Android с использованием языка Kotlin;
